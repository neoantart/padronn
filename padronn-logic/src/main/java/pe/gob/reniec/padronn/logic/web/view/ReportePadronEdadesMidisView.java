 ...
 */
public class ReportePadronEdadesMidisView extends AbstractPOIExcelView  {

    private String pathExcel = "/WEB-INF/formato/Reporte-padron-edades-midis";
    ...
    protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        for (Ubigeo ubigeo: list) {
            ...
            cell.setCellValue(ubigeo.getNuEdad0());
            columnaCount++;
            ...
            cell.setCellValue(ubigeo.getNuEdad1());
            columnaCount++;
            ...
            cell.setCellValue(ubigeo.getNuEdad2());
            columnaCount++;
            ...
            cell.setCellValue(ubigeo.getNuEdad3());
            columnaCount++;
            ...
            cell.setCellValue(ubigeo.getNuEdad4());
            columnaCount++;
            ...
            cell.setCellValue(ubigeo.getNuEdad5());
            columnaCount++;

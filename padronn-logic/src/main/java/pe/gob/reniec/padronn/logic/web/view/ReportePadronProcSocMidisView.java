 ...
 */
public class ReportePadronProcSocMidisView extends AbstractPOIExcelView  {

    private String pathExcel = "/WEB-INF/formato/Reporte-padron-proc-soc-midis";
    ...
    protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        for (Ubigeo ubigeo: list) {
            ...
            cell.setCellValue(ubigeo.getNuPvl());
            columnaCount++;
            ...
            cell.setCellValue(ubigeo.getNuCuna());
            columnaCount++;
            ...
            cell.setCellValue(ubigeo.getNuJuntos());
            columnaCount++;
            ...
            cell.setCellValue(ubigeo.getNuQaliwarma());
            columnaCount++;

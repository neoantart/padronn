...
/**
 * Created by paguilar on 24/02/2015.
 */
public class ReportePadronBajasView extends AbstractPOIExcelView{

    private String pathExcel = "/WEB-INF/formato/Reporte-padron-baja";
    ...
    protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (nombreArchivo == null || nombreArchivo.isEmpty()) {
            nombreArchivo = "Reporte-padron-baja.xlsx";
        }

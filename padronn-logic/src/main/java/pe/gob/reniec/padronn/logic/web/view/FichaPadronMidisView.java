 ...
 */
public class FichaPadronMidisView extends AbstractITextPdfView {
    ...
    static {
        ...
        URL resource = FichaPadronMidisView.class.getResource("/META-INF/web-resources/img/logo-reniec.png");
        URL resourceSinFotoM = FichaPadronMidisView.class.getResource("/META-INF/web-resources/img/sin_foto_masculino.jpg");
        URL resourceSinFotoF = FichaPadronMidisView.class.getResource("/META-INF/web-resources/img/sin_foto_femenino.jpg");
...
//        canvas.rectangle(margin, margin, document.getPageSize().getWidth() - 2 * margin, document.getPageSize().getHeight() - 2 * margin);
    ...
    private PdfPTable createDatosMenor1(PadronNominal padronNominal) {
        ...
        tableInformation.addCell(getCellLabel("Primer Apellido:"));
        tableInformation.addCell(getCell(padronNominal.getApPrimerMenor()));
        tableInformation.addCell(getCellLabel("Segundo Apellido:"));
        ...
        tableInformation.addCell(getCellLabel("Fe. Nacimiento:"));
    ...
    private PdfPTable createDatosMenor2(PadronNominal padronNominal){
     /*   try {
        ...
        try {
            if (padronNominal.getCoPadronNominal() != null && padronNominal.getImagen()!=null) {
                fotoImg = Image.getInstance(padronNominal.getImagen());
                //fotoImg = Image.getInstance(resourceFoto);
            }
        } catch (Exception e) {
            try {
                fotoImg = Image.getInstance(resourceFoto);
    ...
    private PdfPTable createInfoAdic1(PadronNominal padronNominal){
        ...
        tableInformation.getDefaultCell().setBorder(0);
        tableInformation.addCell(getCellLabel("Establecimiento de salud:"));
        tableInformation.addCell(getCell(""));
        ...
        tableInformation.addCell(getCell(padronNominal.getCoEstSalud()));
        tableInformation.addCell(getCellLabel("Tipo de seguro:"));
    ...
    private PdfPTable createDatosMadre2(PadronNominal padronNominal){
        ...
        tableInformation.addCell(getCell(padronNominal.getDeGraInstMadre()));
        tableInformation.addCell(getCellLabel("Lengua Habitual:"));
        tableInformation.addCell(getCell(padronNominal.getDeLenMadre()));
    ...
    protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        tableLayout.addCell(getCellSubTitle("2. Datos de la Madre"));
        tableLayout.addCell(createDatosMadre1(padronNominal));
        tableLayout.addCell(createDatosMadre2(padronNominal));
        tableLayout.addCell(getCellSubTitle("3. Datos del jefe de familia"));
